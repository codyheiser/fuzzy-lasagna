...
if __name__ == "__main__":
	...
	make_fig(cv2.cvtColor(image, cv2.COLOR_BGR2RGB), name='Input', size=(10,10))
	...
	make_fig(cv2.cvtColor(thresh, cv2.COLOR_BGR2RGB), name='Threshold', size=(10,10))

	# identify segments and markup original image
	image = run_watershed(image, thresh)
	# show the output image
	make_fig(cv2.cvtColor(image, cv2.COLOR_BGR2RGB), name='Markup', size=(10,10))
